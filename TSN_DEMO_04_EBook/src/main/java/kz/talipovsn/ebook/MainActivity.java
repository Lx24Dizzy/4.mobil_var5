...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.lec03) {
            webView.loadUrl(resourceDir + "LEC03/lec03.htm");
        } else if (id == R.id.lec04) {
            webView.loadUrl(resourceDir + "LEC04/lec04.htm");
        } else if (id == R.id.lec05) {
            webView.loadUrl(resourceDir + "LEC05/lec05.htm");
        } else if (id == R.id.lec06) {
            webView.loadUrl(resourceDir + "LEC06/lec06.htm");
        } else if (id == R.id.lec07) {
            webView.loadUrl(resourceDir + "LEC07/lec07.htm");
        } else if (id == R.id.lec08) {
            webView.loadUrl(resourceDir + "LEC08/lec08.htm");
        } else if (id == R.id.lec09) {
            webView.loadUrl(resourceDir + "LEC09/lec09.htm");
        } else if (id == R.id.lec10) {
            webView.loadUrl(resourceDir + "LEC10/lec10.htm");
        } else if (id == R.id.lec11) {
            webView.loadUrl(resourceDir + "LEC11/lec11.htm");
        } else if (id == R.id.lec12) {
            webView.loadUrl(resourceDir + "LEC12/lec12.htm");
